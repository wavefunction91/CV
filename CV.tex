...
\begin{itemize} \itemsep -2pt
  \item Accelerated DFT (Microsoft)
...
\subsection{Microsoft Quantum\hfill 2024-Present}
\begin{etaremune}
  \item Ju. F.; Wei, X.; Huang, L.; Jenkins, A.J.J; Xia, L.; Zhang, J.; Zhu, J.; Yang, H.; Shao, B.; 
        Dai, P.; \me; Mayya, A.; Hooshmand, Z.; Efimovskaya, A.; Baker, N.A.; Troyer, M.; Liu, H.;
        ``\emph{Acceleration without Disruption: DFT Software as a Service}"
        \emph{J. Chem. Theory Comput.} \textbf{2024}. 20, 24, 10838–10851. 
\end{etaremune}
...
\begin{etaremune}
  ...
  \item Shen, Y.; Camps, D.; Szaz, A.; Darbha, S.; Klymko, K.; \me; Tubman, N.B.; Van Beeumen, R.;
        ...
        \emph{2023 ICCC International Conference on Quantum Computing and Engineering (QCE)}. \textbf{2023}.
...
\begin{etaremune}
  \item * \presentation%
        {\me}%
        {Quantum, AI, HPC and the Path to Commercial Advantage}%
        {HPC/AI Integration with Quantum Computing (HAIQ) Workshop, International Symposium on High-Performance Computer Architecture (HPCA)}%
        {Las Vegas, NV}%
        {2025}%
        {Oral Presentation}
  \item * \presentation%
        {\me}%
        {Pushing Chemistry Boundaries with Quantum and High-Performance Computing}%
