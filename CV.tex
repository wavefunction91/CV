...
Computational Chemisty, Materials and Climate Group (CCMC),\\
Applied Mathematics and Computational Research Division (AMCR),\\ 
...
{\sl \bf Research Scientist} \dotfill February 2021 -- Present \\
...
\begin{center}
{\bf 26 in press publications, 1 accepted pending publication, 7 as first author (named), \\3 as equally contributing (first) author, 2 invited.}\\
