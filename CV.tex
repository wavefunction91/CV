...
\address{Research Scientist (Career-Track),\\
Applied Commputing for Scientific Discovery Group (ACSD),\\
...
{\sl \bf Research Scientist (Career-Track)} \dotfill February 2021 -- Present \\
...
\begin{itemize} \itemsep -2pt
  ...
  \item Massively Parallel Quantum Chemistry (MPQC4) ({\sl Contributor})
  \item TiledArray ({\sl Contributor})
...
\begin{center}
{\bf 28 in press publications, 1 accepted pending publication, 5 submitted manuscripts, \\
  9 as first author (named), 3 as equally contributing (first) author, 5 invited.}\\
...
\begin{etaremune}
  \item $\dagger$ \me; Popovici, D.T; Clark, D.; Asadchev, A.; Waldrop, J.; Windus, T.L.;
        Valeev, E.F.; de Jong, W.A;
        ``\emph{Massively Parallel, GPU Accelerated Fock Construction for Hybrid, Gaussian 
                Basis Density Functional Theory}";
        \emph{J. Chem. Phys.}; \textbf{2023}. Submitted.
