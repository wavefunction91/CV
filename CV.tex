...
\address{Computational Research Division \\ 
...
%  dynamics of quantum molecular systems.
  ...
  (Krylov solvers).
  \item Application of abstract mathematical paradigms, such as algebraic
  topology and differential geometry, to develop elegant and novel solutions to
  the problems that arise in ab initio electronic structure theory.
\end{itemize}
...
\begin{itemize} \itemsep -2pt
  \item {\sl Programming Languages:} C++
  \item {\sl Libraries / Paradigms:} OpenMP, MPI, BLAS/LAPACK, CUDA
\end{itemize}

I am very proficient in the following computational areas:
\begin{itemize} \itemsep -2pt
  \item {\sl Programming Languages:} C, FORTRAN 77/95/03
...
\begin{center}
{\bf 21 in press publications, 1 accepted pending publication, 2 submitted manuscripts, 6 as first author (named), 3 as equally contributing (first) author, 2 invited.}\\
...
\begin{etaremune}
  ...
  \item $\dagger$ \me; de Jong, W.A; van Dam, H.J.J.; \cy;
        ...
        \emph{Frontiers in Chemistry}, \textbf{2020}, Accepted.
