...
\begin{etaremune}
  ...
  \item \me; Lingerfelt, D.~B.; Petrone, A.; \xsli;
	``\emph{Ab Initio Surface Hoppings Dynamics within the Particle-Particle 
...
\section{\centerline{SOFTWARE CITATIONS}} 
\vspace{15pt} % Gap between title and text
...
\item Frisch,~M.~J.; Trucks,~G.~W.; Schlegel,~H.~B.; Scuseria,~G.~E.; Robb,~M.~A.;
      ...
      \emph{Gaussian Development Version, Revision I.06},
